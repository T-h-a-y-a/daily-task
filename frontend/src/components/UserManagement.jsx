  ...
  const handleCreateUser = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (showToast) showToast(`User "${newUser.username}" created successfully!`);
                    ...
                    {currentUser?.role === 'admin' && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <button 
                          ...
                          onClick={(e) => { e.stopPropagation(); onCreateSubProject(cat); }}
                        >
                            ...
                            {currentUser?.role === 'admin' && (
                              <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                                <button 
                                  ...
                                  onClick={(e) => { e.stopPropagation(); onEditSubProject(proj); }}
                                ...
                                <button 
                                  ...
                                  onClick={(e) => { e.stopPropagation(); onDeleteSubProject(proj); }}
