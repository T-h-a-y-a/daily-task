  ...
  return (
    <div className="animate-fade-in" style={styles.page}>
      ...
      <div style={styles.header}>
        <div>
          <h1 style={styles.pageTitle}>File Upload & Task Reports</h1>
          <p style={styles.pageSubtitle}>
            Report Management for Task: <strong style={{ color: 'var(--text-primary)' }}>{task.title}</strong>
          </p>
        </div>
        {isAdmin && (
      ...
      {isAdmin && (
        ...
        >
          ...
          <p style={{ fontSize: '0.82rem', color: 'var(--text-muted)', marginTop: '4px', textAlign: 'center' }}>
            Click here to select and upload reports (PDF, Word, Excel, Images, CSV - max 30MB)
          </p>
        </div>
      )}
