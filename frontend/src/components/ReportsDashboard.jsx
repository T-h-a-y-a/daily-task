...
export default function ReportsDashboard({ tasks, setTasks, currentUser, isAdmin, availableCategories = [] }) {
  ...
  const handleAddReport = async (e) => {
    e.preventDefault();
    if (!reportTitleInput.trim() || isSubmitting) return;
    ...
    try {
      if (editingReport) {
        ...
        if (res.ok) {
          ...
          alert('Failed to save report. Please check the server connection.');
        }
      }
    } catch (err) {
            ...
            <div style={styles.formGrid}>
              ...
              <div style={styles.inputGroup}>
                ...
                <input 
                  ...
                  className="input-field" 
                  placeholder="e.g. SEO, Website Development, Reports..."
          ...
          {filteredReports.map(rpt => {
            ...
            return (
              <div key={rpt.id} className="glass-panel animate-fade-in" style={styles.reportCard}>
                {/* Header: Category & Frequency Badges */}
                <div style={styles.cardHeader}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
                    ...
                    <span style={styles.categoryBadge}>
                      <Folder size={12} /> Heading: {rpt.category || 'Reports'}
                    </span>
                    ...
                    {isAdmin && isWithin24Hours(rpt.date) && (
                      <>
                        ...
                        <button 
                          ...
                          onClick={() => handleDeleteReport(rpt.id || rpt._id)}
